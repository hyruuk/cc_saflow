...
%% Use this modified version for go-nogo with alternating hands
%r1 = 52; % 4, left hand
%r2 = 55; % 7, right hand
for n=1:numberoftrials
    if (response(n,1)==2 & response(n,2)==r1) | (response(n,1)==2 & response(n,2)==r2)
        response(n,7)=1;
    elseif (response(n,1)==1 & response(n,2)==r2) | (response(n,1)==1 & response(n,2)==r1)
        response(n,7)=-1;
    end;
end;