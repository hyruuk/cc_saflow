...
if __name__ == "__main__":
    ...
    allfreqs_acc.append(np.array(allchans_acc)) #array, shape (n_chan,)
    allfreqs_pval.append(np.array(allchans_pval)) #array, shape (n_chan,)
    ...
    ch_xy = get_ch_pos(epochs) #type : np.ndarray, shape : (n_chan, 2)
