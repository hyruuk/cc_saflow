...
subjects_dir: Optional[PathLike] = '/media/hyruuk/CoCoLabYANN/coco_data/saflow/fs_subjects'
# """
...
ch_types: Iterable[Literal["meg", "mag", "grad", "eeg"]] = ["meg"]
# """
...
eog_channels: Optional[Iterable[str]] = 'vEOG'
# """
...
h_freq: Optional[float] = 200
# """
# The high-frequency cut-off in the lowpass filtering step.
# Keep it `None` if no lowpass filtering should be applied.
# """

notch_freq: Optional[Union[float, Iterable[float]]] = [60, 120, 180]
# """
...
raw_resample_sfreq: Optional[float] = 600
# """
...
conditions: Optional[Union[Iterable[str], Dict[str, str]]] = ['Freq', 'Rare', 'Resp']
# """
...
contrasts: Iterable[Union[Tuple[str, str], ArbitraryContrast]] = [('Freq', 'Rare')]
# """
...
# ~~~~~~~~~~~~~~~~~~~~~~
ica_reject: Optional[Dict[str, float]] = {'grad': 10e-10, 'mag': 20e-12}
# """
...
ica_algorithm: Literal["picard", "fastica", "extended_infomax"] = "fastica" #try others ?
# """
...
time_frequency_conditions: Iterable[str] = ['Freq', 'Rare']
# """
...
time_frequency_freq_min: Optional[float] = 1
# """
...
time_frequency_freq_max: Optional[float] = 200
# """
